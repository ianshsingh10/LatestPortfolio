...
export const NavBody = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-2xl flex-row items-center justify-around self-start rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
